...
NEWS_QUERIES = [
    ...
    {"query": "スマホ 新機能", "label": "テクノロジー"},
    {"query": "アプリ 話題", "label": "テクノロジー"},
    {"query": "通信料 値下げ", "label": "テクノロジー"},
    {"query": "家電 新製品", "label": "テクノロジー"},
    {"query": "電子マネー 新サービス", "label": "テクノロジー"},
    ...
    {"query": "配信サービス 値上げ", "label": "エンタメ"},
    {"query": "ライブ チケット代", "label": "エンタメ"},
]
...
✅ テクノロジー（日本の生活に直結する新製品・サービスのみ。ただしAI関連は除外）
✅ 経済（倒産・リストラ・値上げなど一般人の生活に直撃するもの限定）
✅ エンタメ（お金に絡むエンタメのみ）

❌ 避けるニュース
- AI・人工知能・ChatGPT・生成AIに関する記事（全て除外）
- 硬すぎる金融政策（FRB・長期金利◯%など）
- 海外マーケット速報（NYダウ・S&P500・米国金利の日次変動など）
- 投資家・アナリスト向けの決算分析（「Goldman格上げ」「WBD撤退」等の専門用語が多い記事）
- 海外企業の業界ニュース（テスラの新車開発など日本の生活に直結しないもの）
- 副業紹介・副業おすすめ
- お金と無関係の芸能ゴシップ・エンタメ
- スポーツ結果、事件・事故・災害

【初心者向けの基準（重要）】
投資初心者・主婦でも「へぇ〜」「えっマジ？」と反応できる記事だけを選ぶこと。
以下のような記事は難しすぎるので絶対に選ばない：
- 「NYマーケットダイジェスト」「マーケット概況」系の速報
- 「格上げ」「格下げ」「PER」「EPS」等の投資用語が中心の記事
- 海外企業のビジネス戦略（一般人に馴染みがない企業の話）
選ぶべきは「自分の生活・財布に直結する」「身近な人に話したくなる」ニュース。
